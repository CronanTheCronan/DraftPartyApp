...
namespace DraftPartyApp.App_Data
{
	...
	public partial class FootbalLinqDataDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTeam(Team instance);
		...
		public FootbalLinqDataDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DBCS"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public FootbalLinqDataDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public FootbalLinqDataDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public FootbalLinqDataDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public FootbalLinqDataDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Oncollege_nameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_college_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_college_name", DbType="NVarChar(150) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="College_Player", Storage="_Players", ThisKey="college_id", OtherKey="college_id")]
    ...
    partial void Oncollege_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="College_Player", Storage="_College", ThisKey="college_id", OtherKey="college_id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._College.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._college_id = value.college_id;
					}
					else
					{
						this._college_id = default(int);
					}
